...
class ClipHistory(Box):
    def __init__(self, **kwargs):
        ...
        self.filtered_items = []  # <-- New list to hold filtered items
        self._loading = False
    ...
    def display_clipboard_items(self, filter_text=""):
        ...
        self.filtered_items = filtered_items # <-- Store the filtered items here
        ...
        self._display_items_batch(self.filtered_items, 0, 10)
    ...
    def use_selected_item(self):
        ...
        # The fix is here: use the filtered_items list, not the main clipboard_items list
        if not self.filtered_items or self.selected_index == -1 or self.selected_index >= len(self.filtered_items):
            return
    ...
    def delete_selected_item(self):
        ...
        # The fix is here: use the filtered_items list, not the main clipboard_items list
        if not self.filtered_items or self.selected_index == -1:
            return
